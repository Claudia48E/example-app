<html lang="en">
<head>
    <title>Laravel 9 Stripe Payment Gateway</title>
    <meta charset="utf-8">
...
<div class="col-lg-6">
            {{-- <form  action="{{url('payment')}}"  data-cc-on-file="false" data-stripe-publishable-key="pk_test_51MWkFFDfJCOVIMTLLDA4PZJBKWkqiwuUY380twE6h0LYY05Os4H7GptYOgj4gqjBC3NbfOg7LLw3EqX99MAG4F3P00rDTKgQXy" name="frmStripe" id="frmstripe" method="GET"> --}}
...
Total: <span class="amount">Total: ${{Session::get('total')}}</span>
</div>
</div>
</div>
<div class="row">
